...
namespace CFS
{
    ...
    public class Entity : MonoBehaviour
    {
        ...
        [Header("Stats")] public EntityType entityType;
        ...
        [Header("Search")] public LayerMask playerLayer, groundLayer;
        ...
        private void SearchWalkPoint()
        {
            ...
            var newPoint = new Vector3(transform.position.x + randomX, transform.position.y + randomY,
        ...
        private void OnCollisionEnter(Collision other)
        {
            ...
            //if (obj.TryGetComponent<PlayerManager>(out var player)) player.playerStats.OnDamaged(baseDamage);
